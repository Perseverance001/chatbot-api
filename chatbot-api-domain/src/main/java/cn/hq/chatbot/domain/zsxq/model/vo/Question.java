package cn.hq.chatbot.domain.zsxq.model.vo;
...
public class Question {
    ...
    private OwnerDdetail owner_detail;
    ...
    public void setOwner_detail(OwnerDdetail owner_detail){
        this.owner_detail = owner_detail;
    }
    public OwnerDdetail getOwner_detail(){
