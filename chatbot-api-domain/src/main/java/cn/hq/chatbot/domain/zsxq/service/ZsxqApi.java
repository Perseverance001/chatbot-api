package cn.hq.chatbot.domain.zsxq.service;
import cn.hq.chatbot.domain.zsxq.IZsxqApi;
import cn.hq.chatbot.domain.zsxq.model.aggregates.UnAnsweredQuestionsAggregates;
import cn.hq.chatbot.domain.zsxq.model.req.AnswerReq;
import cn.hq.chatbot.domain.zsxq.model.req.ReqData;
import cn.hq.chatbot.domain.zsxq.model.res.AnswerRes;
...
public class ZsxqApi implements IZsxqApi {
    ...
    public UnAnsweredQuestionsAggregates queryUnAnsweredQuestionsTopicId(String groupId, String cookie) throws IOException {
        ...
        org.apache.http.client.methods.HttpGet get = new HttpGet("https://api.zsxq.com/v2/groups/" + groupId + "/topics?scope=unanswered_questions&count=20");
        ...
        if(response.getStatusLine().getStatusCode() == HttpStatus.SC_OK){
            ...
            logger.info("拉取星球提问数据。groupId:{},jsonStr:{}",groupId,jsonStr);
